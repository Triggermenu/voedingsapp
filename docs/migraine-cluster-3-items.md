...
## G. Uitbreiding 2026-05-21 — Gefermenteerde/ingeblikte vis (vis-schaaldieren.json)

Zelfde tyramine/biogene-aminen-pathway als de kazen (zie rationale-doc § Uitbreiding 2026-05-21). Niet cluster 7 (= nitriet/NO-pathway).

| ID | Naam | Categorie | Mig-score | triggerType | Cluster |
|---|---|---|---|---|---|
| `nl-makreel-blik` | Makreel (blik, in eigen sap) | vis-schaaldieren | 2 | subgroep-overschat | 3 |
| `nl-gravad-lax` | Gravad lax (gezouten zalm) | vis-schaaldieren | 2 | subgroep-overschat | 3 |
| `nl-haring-rolmops` | Rolmops (ingelegde haring) | vis-schaaldieren | 2 | subgroep-overschat | 3 |

primaryModulators alle drie: `["tyramine", "histamine"]`. Bronset: Finberg 2022 + Maintz 2007 + Hindiyeh 2020.
